 ...
 * API 引导式配置
 */
public class RtmpConfig extends JFinalConfig {
	...
	public static void main(String[] args) {
		UndertowServer.create(RtmpConfig.class).start();
	}
	...
	static void loadConfig() {
		if (p == null) {
			p = PropKit.useFirstFound("rtmp-config-pro.txt", "rtmp-config-dev.txt");
		}
	}
